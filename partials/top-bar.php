					...
					<form role="search" id="search-form" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
						<div class="search-table">	
							<div class="search-button">
						        ...
						        <span class="screen-reader-text"><?php _e('Search', 'generatepress_child'); ?></span>
						        <i class="fal fa-search" style=""></i>
						        </button>
							</div>
							<div class="search-field">
								<label class="screen-reader-text" for="search-input"><?php _e('Search Products', 'generatepress_child'); ?></label>
						        <input type="search" placeholder="<?php _e('Search Products', 'generatepress_child'); ?>" name="s" id="search-input" value="<?php echo esc_attr( get_search_query() ); ?>" />
							</div>
						</div>
					</form>
				</div>
						...
						<form role="search" id="search-form" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
							<div class="search-table">	
								<div class="search-button">
							        <button type="submit" id="search-submit">
							        <span class="screen-reader-text"><?php _e('Search', 'generatepress_child'); ?></span>
							        <?php _e('Search', 'generatepress_child'); ?>
							        </button>
								</div>
								<div class="search-field">
									<label class="screen-reader-text" for="search-input"><?php _e('Search site', 'generatepress_child'); ?></label>
							        <input type="search" placeholder="<?php _e('Search site', 'generatepress_child'); ?>" name="s" id="search-input" value="<?php echo esc_attr( get_search_query() ); ?>" />
								</div>
							</div>
						</form>
					</div>
